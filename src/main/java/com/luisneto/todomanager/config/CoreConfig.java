...
@ComponentScan(basePackages = { "com.luisneto.todomanager.repository", "com.luisneto.todomanager.service" })
public class CoreConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		em.setPackagesToScan(new String[] { "com.luisneto.todomanager.domain" });
